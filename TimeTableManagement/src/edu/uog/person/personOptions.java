...
public class personOptions {
	...
	public static void saveOption() throws Exception {
		...
		System.out.println("Note: Enter Student if the person is student or Enter Teacher if the person is teacher.....!!!!");
		System.out.println("Enter Person's Title: ");
			String title = scan.nextLine();
			person.setTITLE(title);
		System.out.println("Enter "+person.getTITLE()+"'s Fore Name: ");
			String foreName = scan.nextLine();
			person.setFORE_NAME(foreName.toUpperCase());
		System.out.println("Enter "+person.getTITLE()+"'s Sur Name: ");
			String surName = scan.nextLine();
			person.setSUR_NAME(surName.toUpperCase());
		System.out.println("Enter "+person.getTITLE()+"'s Age: ");
			int age = scan.nextInt();
			person.setAGE(age);
		System.out.println("Enter "+person.getTITLE()+"'s Gender: ");
			String gender = scan.nextLine();
			gender += scan.nextLine();
			person.setGENDER(gender);
		System.out.println("Enter "+person.getTITLE()+"'s Address: ");

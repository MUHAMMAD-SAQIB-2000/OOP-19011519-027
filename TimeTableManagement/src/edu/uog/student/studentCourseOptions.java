...
public class studentCourseOptions {
	...
	public static void  findallOption() {
		...
		List<StudentCourse> Students = StudentCourseData.findAll();
	...
	public static void  findoneOption() {
		...
		Scanner scan = new Scanner(System.in);
		int op = scan.nextInt(); 
		StudentCourse Student = StudentCourseData.findOne(op);
	...
	public static void  searchOption() {
		...
		List<StudentCourse> Students = StudentCourseData.search("19011519-");
		for (int i=0; i<Students.size(); i++) {
			System.out.println(Students.get(i).toString());
		}
		try {
